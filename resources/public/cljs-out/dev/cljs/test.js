...
var G__10065 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10065,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10065;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10067){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10068,G__10069,seq10067__$2);
});
...
var file = cljs.core.get.call(null,map__10074__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10074__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10074__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__10074,map__10074__$1,file,line,column){
return (function (p1__10073_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10073_SHARP_));
});})(map__10074,map__10074__$1,file,line,column))
...
var temp__5735__auto___10076 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___10076)){
var message_10077 = temp__5735__auto___10076;
cljs.core.println.call(null,message_10077);
} else {
}
...
var temp__5735__auto___10078 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___10078)){
var message_10079 = temp__5735__auto___10078;
cljs.core.println.call(null,message_10079);
} else {
}
...
var output_dir__$1 = (function (){var G__10080 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__10080,"/"].join('');
} else {
return G__10080;
}
})();
...
var G__10082 = exception.stack;
var G__10082__$1 = (((G__10082 == null))?null:clojure.string.split_lines.call(null,G__10082));
var G__10082__$2 = (((G__10082__$1 == null))?null:cljs.core.get.call(null,G__10082__$1,depth));
if((G__10082__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10082__$2);
}
} else {
...
var vec__10083 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10083,(0),null);
var column = cljs.core.nth.call(null,vec__10083,(1),null);
var vec__10086 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10086,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10086,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10086,(2),null);
...
var m__$1 = (function (){var G__10089 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__10089__$1 = (((G__10089 instanceof cljs.core.Keyword))?G__10089.fqn:null);
switch (G__10089__$1) {
case "fail":
...
var G__10093 = (function (){var G__10092 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10092);
} else {
return G__10092;
}
})();
...
return cljs.core.vary_meta.call(null,G__10094,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__10098 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10098,(0),null);
var types = vec__10098;
...
return cljs.core.map.call(null,(function (p__10101){
var vec__10102 = p__10101;
var ns = cljs.core.nth.call(null,vec__10102,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10102,(1),null);
return ((function (vec__10102,ns,vars__$1){
return (function (){
...
var G__10105 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__10105,G__10105__$1,env,once_fixtures,each_fixtures,vec__10102,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__10105,G__10105__$1,env,once_fixtures,each_fixtures,vec__10102,ns,vars__$1){
return (function (){
var seq__10106 = cljs.core.seq.call(null,vars__$1);
var chunk__10107 = null;
var count__10108 = (0);
var i__10109 = (0);
while(true){
if((i__10109 < count__10108)){
var v = cljs.core._nth.call(null,chunk__10107,i__10109);
var temp__5735__auto___10111 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___10111)){
var t_10112 = temp__5735__auto___10111;
each_fixture_fn.call(null,((function (seq__10106,chunk__10107,count__10108,i__10109,t_10112,temp__5735__auto___10111,v,each_fixture_fn,G__10105,G__10105__$1,env,once_fixtures,each_fixtures,vec__10102,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10112)));
});})(seq__10106,chunk__10107,count__10108,i__10109,t_10112,temp__5735__auto___10111,v,each_fixture_fn,G__10105,G__10105__$1,env,once_fixtures,each_fixtures,vec__10102,ns,vars__$1))
);
} else {
}


var G__10113 = seq__10106;
var G__10114 = chunk__10107;
var G__10115 = count__10108;
var G__10116 = (i__10109 + (1));
seq__10106 = G__10113;
chunk__10107 = G__10114;
count__10108 = G__10115;
i__10109 = G__10116;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq.call(null,seq__10106);
if(temp__5735__auto__){
var seq__10106__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__10106__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__10106__$1);
var G__10117 = cljs.core.chunk_rest.call(null,seq__10106__$1);
var G__10118 = c__4550__auto__;
var G__10119 = cljs.core.count.call(null,c__4550__auto__);
var G__10120 = (0);
seq__10106 = G__10117;
chunk__10107 = G__10118;
count__10108 = G__10119;
i__10109 = G__10120;
continue;
} else {
var v = cljs.core.first.call(null,seq__10106__$1);
var temp__5735__auto___10121__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___10121__$1)){
var t_10122 = temp__5735__auto___10121__$1;
each_fixture_fn.call(null,((function (seq__10106,chunk__10107,count__10108,i__10109,t_10122,temp__5735__auto___10121__$1,v,seq__10106__$1,temp__5735__auto__,each_fixture_fn,G__10105,G__10105__$1,env,once_fixtures,each_fixtures,vec__10102,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10122)));
});})(seq__10106,chunk__10107,count__10108,i__10109,t_10122,temp__5735__auto___10121__$1,v,seq__10106__$1,temp__5735__auto__,each_fixture_fn,G__10105,G__10105__$1,env,once_fixtures,each_fixtures,vec__10102,ns,vars__$1))
);
} else {
}


var G__10123 = cljs.core.next.call(null,seq__10106__$1);
var G__10124 = null;
var G__10125 = (0);
var G__10126 = (0);
seq__10106 = G__10123;
chunk__10107 = G__10124;
count__10108 = G__10125;
i__10109 = G__10126;
continue;
}
} else {
...
});})(each_fixture_fn,G__10105,G__10105__$1,env,once_fixtures,each_fixtures,vec__10102,ns,vars__$1))
);
});})(each_fixture_fn,G__10105,G__10105__$1,env,once_fixtures,each_fixtures,vec__10102,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10105__$1)].join('')));

}
})());
});
;})(vec__10102,ns,vars__$1))
