...
var len__4730__auto___14816 = arguments.length;
var i__4731__auto___14817 = (0);
while(true){
if((i__4731__auto___14817 < len__4730__auto___14816)){
args__4736__auto__.push((arguments[i__4731__auto___14817]));

var G__14818 = (i__4731__auto___14817 + (1));
i__4731__auto___14817 = G__14818;
continue;
} else {
}
break;
...
var reporter__5748__auto___14819 = new cljs.core.Keyword(null,"reporter","reporter",-805360621).cljs$core$IFn$_invoke$arity$1(cljs.test.empty_env.call(null));
if(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("cljs-test-display.core","default","cljs-test-display.core/default",-853427213),null,new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),null], null), null).call(null,reporter__5748__auto___14819))){
} else {
cljs.core._add_method.call(null,cljs.test.report,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reporter__5748__auto___14819,new cljs.core.Keyword(null,"end-run-tests","end-run-tests",267300563)], null),((function (reporter__5748__auto___14819){
...
});})(reporter__5748__auto___14819))
);
}

cljs.test.run_block.call(null,(function (){var env14814 = cljs.test.empty_env.call(null);
var summary14815 = cljs.core.volatile_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"summary","summary",380847952),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"test","test",577538877),(0)], null));
return cljs.core.concat.call(null,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (env14814,summary14815,reporter__5748__auto___14819){
return (function (){
cljs.test.set_env_BANG_.call(null,env14814);
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (env__8792__auto__,env14814,summary14815,reporter__5748__auto___14819){
return (function (){
...
});})(env14814,summary14815,reporter__5748__auto___14819))
,((function (env14814,summary14815,reporter__5748__auto___14819){
return (function (){
return cljs.test.do_report.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Symbol(null,"taiwan-id.core-test","taiwan-id.core-test",1581121247,null),new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"end-test-ns","end-test-ns",1620675645)], null));
});})(env14814,summary14815,reporter__5748__auto___14819))
], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (env14814,summary14815,reporter__5748__auto___14819){
return (function (){
return cljs.core._vreset_BANG_.call(null,summary14815,cljs.core.partial.call(null,cljs.core.merge_with,cljs.core._PLUS_).call(null,cljs.core._deref.call(null,summary14815),new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242).cljs$core$IFn$_invoke$arity$1(cljs.test.get_and_clear_env_BANG_.call(null))));
});})(env14814,summary14815,reporter__5748__auto___14819))
], null)),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (env14814,summary14815,reporter__5748__auto___14819){
return (function (){
cljs.test.set_env_BANG_.call(null,env14814);

cljs.test.do_report.call(null,cljs.core.deref.call(null,summary14815));

cljs.test.report.call(null,cljs.core.assoc.call(null,cljs.core.deref.call(null,summary14815),new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"end-run-tests","end-run-tests",267300563)));
...
/** @this {Function} */
taiwan_id.test_runner._main.cljs$lang$applyTo = (function (seq14813){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq14813));
});
