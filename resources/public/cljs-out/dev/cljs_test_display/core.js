...
var len__4730__auto___10158 = arguments.length;
var i__4731__auto___10159 = (0);
while(true){
if((i__4731__auto___10159 < len__4730__auto___10158)){
args__4736__auto__.push((arguments[i__4731__auto___10159]));

var G__10160 = (i__4731__auto___10159 + (1));
i__4731__auto___10159 = G__10160;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq10155){
var G__10156 = cljs.core.first.call(null,seq10155);
var seq10155__$1 = cljs.core.next.call(null,seq10155);
var G__10157 = cljs.core.first.call(null,seq10155__$1);
var seq10155__$2 = cljs.core.next.call(null,seq10155__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10156,G__10157,seq10155__$2);
});
...
var vec__10161 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__10161,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__10161,(1),null);
var G__10164 = cljs.core.PersistentArrayMap.EMPTY;
var G__10164__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__10164,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10164);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__10164__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__10164__$1;
}
} else {
...
return (function() { 
var G__10168__delegate = function (klass,contents){
var vec__10165 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__10165,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__10165,(1),null);
...
var G__10168 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__10169__i = 0, G__10169__a = new Array(arguments.length -  1);
while (G__10169__i < G__10169__a.length) {G__10169__a[G__10169__i] = arguments[G__10169__i + 1]; ++G__10169__i;}
  contents = new cljs.core.IndexedSeq(G__10169__a,0,null);
} 
return G__10168__delegate.call(this,klass,contents);};
G__10168.cljs$lang$maxFixedArity = 1;
G__10168.cljs$lang$applyTo = (function (arglist__10170){
var klass = cljs.core.first(arglist__10170);
var contents = cljs.core.rest(arglist__10170);
return G__10168__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__10174){
var map__10175 = p__10174;
var map__10175__$1 = (((((!((map__10175 == null))))?(((((map__10175.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10175.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10175):map__10175);
var ns = cljs.core.get.call(null,map__10175__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__10175__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__10177){
...
var actual = cljs.core.get.call(null,map__10178__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__10178__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__10180){
...
var expected = cljs.core.get.call(null,map__10181__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__10181__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__10183_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__10185 = cljs_test_display.core.current_var_info.call(null);
...
var info = map__10185__$1;
var name = cljs.core.get.call(null,map__10185__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__10185__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__10185__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__10185,map__10185__$1,info,name,line,file,node){
return (function (p1__10184_SHARP_){
return cljs.core.cons.call(null,node,p1__10184_SHARP_);
});})(curr_node,map__10185,map__10185__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__10187){
...
var m = map__10188__$1;
var fail = cljs.core.get.call(null,map__10188__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__10188__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__10188__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__10188__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5735__auto___10190 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___10190)){
var message_10191 = temp__5735__auto___10190;
cljs.core.println.call(null,message_10191);
} else {
}
...
var temp__5735__auto___10192 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___10192)){
var message_10193 = temp__5735__auto___10192;
cljs.core.println.call(null,message_10193);
} else {
}
