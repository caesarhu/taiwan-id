...
var o__12047__auto___14099 = (function (){var o__12047__auto__ = (function (){var o__12047__auto__ = Promise;
return (o__12047__auto__["resolve"]).call(o__12047__auto__);
})();
return (o__12047__auto__["then"]).call(o__12047__auto__,callback);
})();
(o__12047__auto___14099["catch"]).call(o__12047__auto___14099,devtools.async.rethrow_outside_promise);
...
var G__14100_14101 = Error;
var target__12052__auto___14102 = G__14100_14101;
if(cljs.core.truth_(target__12052__auto___14102)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14100_14101)].join(''),"\n","target__12052__auto__"].join('')));
}

(target__12052__auto___14102["stackTraceLimit"] = Infinity);
