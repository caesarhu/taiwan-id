...
var o12935 = temp__5733__auto__;
var temp__5733__auto____$1 = (o12935["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o12936 = temp__5733__auto____$1;
return (o12936["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12047__auto__ = f;
return (o__12047__auto__["toString"]).call(o__12047__auto__);
} else {
return "";
}
...
try{var o__12047__auto___12939 = t;
(o__12047__auto___12939["cljs$lang$ctorPrWriter"]).call(o__12047__auto___12939,t,writer);
}catch (e12938){var __12940 = e12938;
}
...
var char_code = (function (){var o__12047__auto__ = (new String(char$));
return (o__12047__auto__["charCodeAt"]).call(o__12047__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12047__auto__ = String;
return (o__12047__auto__["fromCharCode"]).call(o__12047__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12941 = num_code;
switch (G__12941) {
case (1):
return (185);
...
var o__12047__auto__ = String;
return (o__12047__auto__["fromCharCode"]).call(o__12047__auto__,superscript_code);
});
/**
...
}catch (e12943){var _e__12054__auto__ = e12943;
return false;
}})())){
...
var vec__12944 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__12944,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o12947 = temp__5733__auto__;
var temp__5733__auto____$1 = (o12947["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o12948 = temp__5733__auto____$1;
return (o12948["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___12955 = arguments.length;
var i__4731__auto___12956 = (0);
while(true){
if((i__4731__auto___12956 < len__4730__auto___12955)){
args__4736__auto__.push((arguments[i__4731__auto___12956]));

var G__12957 = (i__4731__auto___12956 + (1));
i__4731__auto___12956 = G__12957;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12951){
var vec__12952 = p__12951;
var ns_detector = cljs.core.nth.call(null,vec__12952,(0),null);
...
var G__12958 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__12959 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__12958;
remaining_tokens = G__12959;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12949){
var G__12950 = cljs.core.first.call(null,seq12949);
var seq12949__$1 = cljs.core.next.call(null,seq12949);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12950,seq12949__$1);
});
...
var vec__12963 = cljs.core.split_with.call(null,(function (p1__12962_SHARP_){
return cljs.core.not_EQ_.call(null,p1__12962_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__12963,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__12963,(1),null);
...
var vec__12969 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__12969,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__12969,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__12972 = cljs.core.rest.call(null,remaining_tokens);
var G__12973 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__12972;
name_tokens = G__12973;
continue;
} else {
...
var vec__12976 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__12976,(0),null);
var arity = cljs.core.nth.call(null,vec__12976,(1),null);
var vec__12979 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__12979,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__12979,(1),null);
var vec__12982 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__12982,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__12982,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__12982,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__12982,(3),null);
...
var vec__12988 = result;
var munged_ns = cljs.core.nth.call(null,vec__12988,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__12988,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__12988,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__12988,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__12988,(4),null);
var arity = cljs.core.nth.call(null,vec__12988,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__12992 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__12992,(0),null);
var args = cljs.core.nth.call(null,vec__12992,(1),null);
var vec__12995 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__12995,(0),null);
var name = cljs.core.nth.call(null,vec__12995,(1),null);
...
var G__12998 = (arity + (1));
var G__12999 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__13000){
var vec__13001 = p__13000;
var arity = cljs.core.nth.call(null,vec__13001,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__13001,(1),null);
...
return cljs.core.get.call(null,arities,p1__13004_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__13005_SHARP_);
...
args__4736__auto__.push((arguments[i__4731__auto___13013]));
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__13008){
var vec__13009 = p__13008;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__13009,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq13006){
var G__13007 = cljs.core.first.call(null,seq13006);
var seq13006__$1 = cljs.core.next.call(null,seq13006);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13007,seq13006__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__13017__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__13017__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__13017__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__13017__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__13018 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__13018,(0),null);
var fn_name = cljs.core.nth.call(null,vec__13018,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__13018,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__13018,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__13018,(4),null);
var arity = cljs.core.nth.call(null,vec__13018,(5),null);
...
var o__12047__auto__ = f;
return (o__12047__auto__["getBasis"]).call(o__12047__auto__);
});
/**
...
}catch (e13022){var _e__12054__auto__ = e13022;
...
var G__13023 = (obj[cljs.core.first.call(null,path)]);
var G__13024 = cljs.core.rest.call(null,path);
obj = G__13023;
path = G__13024;
continue;
} else {
...
return (function (accum,p__13025){
var vec__13026 = p__13025;
var bit = cljs.core.nth.call(null,vec__13026,(0),null);
var protocol = cljs.core.nth.call(null,vec__13026,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__13029){
var vec__13030 = p__13029;
var ns = cljs.core.nth.call(null,vec__13030,(0),null);
var name = cljs.core.nth.call(null,vec__13030,(1),null);
var selector = cljs.core.nth.call(null,vec__13030,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__13035,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__13035,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__13035,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__13033_SHARP_){
return (obj[cljs.core.first.call(null,p1__13033_SHARP_)]);
});})(name,sorted_matches,vec__13035,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
