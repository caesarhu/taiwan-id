...
var G__13040 = devtools.prefs.pref.call(null,v);
v = G__13040;
continue;
} else {
return v;
...
}catch (e13043){var _e__12054__auto__ = e13043;
return false;
}})();
...
}catch (e13047){var _e__12054__auto__ = e13047;
return false;
}})();
...
}catch (e13049){var _e__12054__auto__ = e13049;
return false;
}}
}
});
...
var vec__13051 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__13051,(0),null);
var name = cljs.core.nth.call(null,vec__13051,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13054_SHARP_);
}),template);
});
