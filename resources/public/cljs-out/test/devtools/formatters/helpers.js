...
var G__11363 = devtools.prefs.pref.call(null,v);
v = G__11363;
continue;
} else {
return v;
...
}catch (e11366){var _e__10377__auto__ = e11366;
return false;
}})();
...
}catch (e11370){var _e__10377__auto__ = e11370;
return false;
}})();
...
}catch (e11372){var _e__10377__auto__ = e11372;
return false;
}}
}
});
...
var vec__11374 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__11374,(0),null);
var name = cljs.core.nth.call(null,vec__11374,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__11377_SHARP_);
}),template);
});
