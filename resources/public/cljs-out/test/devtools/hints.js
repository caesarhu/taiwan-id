...
var file = cljs.core.get.call(null,map__12511__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
}catch (e12510){var _e = e12510;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___12513 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___12513)){
var seen_errors_12514 = temp__5733__auto___12513;
if(cljs.core.truth_(seen_errors_12514.has(self))){
} else {
seen_errors_12514.add(self);

var temp__5735__auto___12515 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___12515)){
var sense_12516 = temp__5735__auto___12515;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_12516)].join('');
} else {
}
}
} else {
