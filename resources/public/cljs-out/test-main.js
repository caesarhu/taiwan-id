var CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=5cc2ab&fwbuild=test"};
...
document.write('<script>goog.require("taiwan_id.test_runner");</script>');
